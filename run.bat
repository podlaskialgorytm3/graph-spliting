...
gcc -c src\graph-partition.c -o build\object-files\graph-partition.o
gcc -c src\board.c -o build\object-files\board.o

rem Link object files into an executable
gcc build\object-files\main.o build\object-files\graph.o build\object-files\graph-partition.o build\object-files\board.o -o program.exe
